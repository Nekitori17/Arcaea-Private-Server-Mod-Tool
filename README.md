...
| **Unified Host** (Combined) | *Both endpoints* | **$\le$ 18 chars** | `ar-sv.nekitori.com` (18B) |
...
python -m arcaea_patcher input.apk -o patched.apk \
  --api-host arc-api.onrender.com \
  --auth-host au-v2.onrender.com

# Example with a unified host (<= 18 characters)
python -m arcaea_patcher input.apk -o patched.apk \
  --api-host ar-sv.onrender.com \
  --auth-host ar-sv.onrender.com
```
...
server:
  api_host: "arc-api.onrender.com"
  auth_host: "au-v2.onrender.com"
